...
vec4		lights_position[10] = { vec4(0.0f,5.f,2.f,1.f),vec4(5.f,5.f,2.f,1.f) , vec4(10.f,5.f,2.f,1.f), vec4(15.f,5.f,2.f,1.f), vec4(20.f,5.f,2.f,1.f),
								vec4(0.0f,10.f,2.f,1.f),vec4(5.f,10.f,2.f,1.f), vec4(10.f,10.f,2.f,1.f), vec4(15.f,10.f,2.f,1.f), vec4(20.f,10.f,2.f,1.f) };

struct light_t
{
	vec4	position = vec4(25.0f, 25.0f, 5.0f, 1.0f);   // directional light
